...
% Can insert loops into http://stackoverflow.com/questions/15396755/using-loops-with-knitr-to-produce-multiple-pdf-reports-need-a-little-help-to
...
Here is some code that doesn't get evaluated--


\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{mean}\hlstd{(d}\hlopt{$}\hlstd{y);} \hlkwd{var}\hlstd{(d}\hlopt{$}\hlstd{y)}
\end{alltt}
\begin{verbatim}
## [1] 0.4593
## [1] 0.09003
